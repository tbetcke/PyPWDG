...
from pypwdg.mesh.structure import MPIDistributedStructure, StructureMatrices
import numpy
import math
...
boundaryentities = []
SMMPI = MPIDistributedStructure(cubemesh, boundaryentities)
...
SMPI,GMPI = impedanceSystem(cubemesh, SMMPI, k, g, trianglequadrature(Nq), elttobasis)
...
#    
    ...
    X = print_timing(spsolve)(SMPI.tocsr(), GMPI)
